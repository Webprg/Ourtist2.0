  ...
  <!-- Portfolio Grid Section -->
    <section id="portfolio" class="bg-light-gray">
        <div class="container">
		   ...
		   <c:forEach items = "${artworkslists}" var = "ab">
				<br>
				 <div class="row">
		            <div class="col-md-7">
		                <a href="#">
		                    <img class="img-responsive" src="images/${ab.filename}"alt="" style="min-height:50px;height:300px; min-width: 20px;width:700px;">
		                </a>
